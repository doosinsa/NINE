...
- `npm run collect:prices` is the Mac/n8n CLI wrapper for the daily price collection route. It posts to a local worker app, accepts `--base-url`, `--date`, and `--tickers`, and prints summary counts without reading or printing provider secret values.
...
- `npm run collect:eps` is the Mac/n8n CLI wrapper for the weekly EPS collection route. It posts to a local worker app, accepts `--base-url`, `--snapshot-date`, `--date`, and `--tickers`, and prints summary counts without reading or printing provider secret values.
...
- `npm run collect:earnings` is the Mac/n8n CLI wrapper for the quarterly earnings collection route. It posts to a local worker app, accepts `--base-url` and `--tickers`, and prints summary counts without reading or printing provider secret values.
...
- `npm run collect:briefs` is the Mac/n8n CLI wrapper for the Core brief collection route. It posts to a local worker app, accepts `--base-url` and `--tickers`, and prints summary counts plus banned-copy detection without reading or printing provider secret values.
